...
git clone --depth=1 --branch=master "https://github.com/TiddlyWiki/TiddlyWiki5.git"
...
git show -q
git remote add deploy "https://$GH_TOKEN@github.com/TiddlyWiki/mws.tiddlywiki.com-gh-pages.git"
