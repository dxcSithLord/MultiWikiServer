...
class SqlTiddlerStore {
  ...
  */
  ...
  saveTiddlersFromPath(tiddler_files_path, bag_name) {
    var self = this;
  ...
  */
  createBag(bag_name, description, options) {
    options = options || {};
    var self = this;
  ...
  allowPrivilegedCharacters - allows "$", ":" and "/" to appear in recipe name
  */
  createRecipe(recipe_name, bag_names, description, options) {
    bag_names = bag_names || [];
  ...
  Returns {tiddler_id:}
  */
  saveBagTiddler(incomingTiddlerFields, bag_name) {
    let _canonical_uri;
  ...
  Returns {tiddler_id:}
  */
  saveBagTiddlerWithAttachment(incomingTiddlerFields, bag_name, options) {
  ...
  */
  saveRecipeTiddler(incomingTiddlerFields, recipe_name) {
  ...
  */
  getRecipeTiddler(title, recipe_name) {
  ...
  */
  getRecipeTiddlers(recipe_name, options) {
  ...
  */
  getRecipeLastTiddlerId(recipe_name) {
    return this.sqlTiddlerDatabase.getRecipeLastTiddlerId(recipe_name);
  }
  deleteAllTiddlersInBag(bag_name) {
    var self = this;
    return this.sqlTiddlerDatabase.transaction(function () {
